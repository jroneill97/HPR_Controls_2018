...
[                                                                                                                           0,                                                                                                                           0,                                                                                                                         0,                                                                                                                           0];
[                                                                                                                           0,                                                                                                                           0,                                                                                                                         0,                                                                                                                           0];
[   (A_fin*d*rho*(2*q1*q3 + 2*q2*q4)*(u^2 + v^2 + w^2)^4)/2 - (A_fin*l*rho*(u^2 + v^2 + w^2)^4*(q1^2 - q2^2 - q3^2 + q4^2))/2,           (A_fin*d*rho*(2*q1*q3 + 2*q2*q4)*(u^2 + v^2 + w^2)^4)/2 - (A_fin*l*rho*(2*q1*q2 - 2*q3*q4)*(u^2 + v^2 + w^2)^4)/2, (A_fin*l*rho*(u^2 + v^2 + w^2)^4*(q1^2 - q2^2 - q3^2 + q4^2))/2 + (A_fin*d*rho*(2*q1*q3 + 2*q2*q4)*(u^2 + v^2 + w^2)^4)/2,           (A_fin*d*rho*(2*q1*q3 + 2*q2*q4)*(u^2 + v^2 + w^2)^4)/2 + (A_fin*l*rho*(2*q1*q2 - 2*q3*q4)*(u^2 + v^2 + w^2)^4)/2];
